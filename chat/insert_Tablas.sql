...
(5, 'Oriente', 'BROFF-2', 'Avenida 789', 'Ciudad 2', 'Estado 2', 'País 2', '+573888888888', 'oriente@oriente.com', 1),
(5, 'Norte', 'BROFF-3', 'Carrera 123', 'Ciudad 3', 'Estado 3', 'País 3', '+573777777777', 'norte@norte.com', 1);
...
(5, 'Supervisor', 'SUP', 'Permisos Supervisión Operación', 1),
...
(5, 'Técnico', 'TEC', 'Permisos Técnicos Limitados', 1),
(5, 'Lider', 'LID', 'Permisos de Liderazgo', 1),
...
(3, NULL, 'C2', 'Centro Principal', 'Centro general', 9876546.00, 1, 1),
(3, 3, 'C2-CC1', 'Centro Tecnología', 'Centro para tecnologia', 87845.00, 2, 1),
(3, 3, 'C2-CC2', 'Centro Gestión Humana', 'Centro para GH', 65412.00, 2, 1),
(3, 3, 'C2-CC3', 'Centro Comercial', 'Centro para Comercial', 48798.00, 2, 1);
...
(10, 3, 1, 1), -- "Marketing" con "Permiso para leer" en "Sucursal"
(12, 31, 1, 1); -- "Marketing" con "Permiso para leer, actualizar, eliminar, importa" en "Sucursal"
...
(5, 45, 2, 1); -- "user4" con "Permiso para actualizar, eliminar, exportar" en "Centro de Costo"
...
(10, 3, 1, 1003, 0), -- "Marketing" con "Permiso para leer" para "Sucursal" con ID 1003
(12, 31, 1, 1002, 0); -- "Marketing" con "Permiso para leer, actualizar, eliminar, importa" con ID 1002
...
(5, 45, 1, 1003, 0), --"user4" con "Permiso para actualizar, eliminar, exportar" en "Centro de Costo" con ID 1003

DECLARE @bitmask INT = 64; -- 2^6 combinaciones
...
BEGIN
    ...
    VALUES (
        CONCAT('Permission_', @counter),
        'Descripción de permiso ' + CAST(@counter AS NVARCHAR),
        (@counter & 1),
        (@counter & 2) / 2,
        (@counter & 4) / 4,
        (@counter & 8) / 8,
